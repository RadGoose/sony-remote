            ...
            while (true)
            {
                ...
                // loop-Menu6
                    while (true) {
                        ...
                        std::getline(cli::tin, select);
                        cli::tout << '\n';
                        if (select == TEXT("stream")) { /* Live View Stream */
                            cli::tout << "Enter target FPS (0=max): ";
                            cli::text fpsStr;
                            std::getline(cli::tin, fpsStr);
                            int fps = 0;
                            try { fps = std::stoi(fpsStr); } catch (...) {}
                            camera->live_view_stream(fps);
                        }
                        else if (select == TEXT("1")) { /* Live View */
